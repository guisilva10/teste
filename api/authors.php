...
<section class="authors">
   ...
   ?>
   <div class="box">
      <p>Editor : <span><?= $fetch_authors['name']; ?></span></p>
      <p>Publicações : <span><?= $total_admin_posts; ?></span></p>
      <p>likes : <span><?= $total_admin_likes; ?></span></p>
      <p>comentários : <span><?= $total_admin_comments; ?></span></p>
      <a href="author_posts.php?author=<?= $fetch_authors['name']; ?>" class="btn">visualizar posts</a>
   </div>
   <?php
      }
   }else{
      echo '<p class="empty">nenhum editor encontrado</p>';
   }
   ?>
