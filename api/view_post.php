...
if(isset($_POST['edit_comment'])){
   ...
   if($verify_comment->rowCount() > 0){
      ...
      $message[] = 'seu comentário foi alterado com sucesso';
   }
}
...
?>
   ...
   <form action="" method="POST">
      ...
      <textarea name="comment_edit_box" required cols="30" rows="10" placeholder="por favor, digite seu comentário"><?= $fetch_edit_comment['comment']; ?></textarea>
...
<section class="comments-container">
   ...
   <p class="comment-title">adicionar comentário</p>
   <?php
      if($user_id != ''){  
   ...
   <form action="" method="post" class="add-comment">
      ...
      <textarea name="comment" maxlength="1000" class="comment-box" cols="30" rows="10" placeholder="escreva seu comentário" required></textarea>
      <input type="submit" value="adicionar" class="inline-btn" name="add_comment">
   </form>
   <?php
   }else{
   ?>
   <div class="add-comment">
      <p>
por favor faça o login para adicionar ou editar o seu comentário</p>
      <a href="login.php" class="inline-btn">Entrar</a>
   </div>
   <?php
      }
   ?>
   ...
   <div class="user-comments-container">
      ...
      <div class="show-comments" style="<?php if($fetch_comments['user_id'] == $user_id){echo 'order:-1;'; } ?>">
         ...
         <form action="" method="POST">
            ...
            <button type="submit" class="inline-option-btn" name="open_edit_box">editar comentário</button>
            <button type="submit" class="inline-delete-btn" name="delete_comment" onclick="return confirm('delete this comment?');">deletar</button>
         </form>
         <?php
         }
         ?>
