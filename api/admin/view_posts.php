   ...
   <div class="box-container">
      ...
      <form method="post" class="box">
         ...
         <div class="flex-btn">
            ...
            <button type="submit" name="delete" class="delete-btn" onclick="return confirm('delete this post?');">deletar</button>
         </div>
         <a href="read_post.php?post_id=<?= $post_id; ?>" class="btn">ver posts</a>
      </form>
      <?php
            }
         }else{
