...
if(isset($_POST['submit'])){
   ...
   if($old_pass != $empty_pass){
      if($old_pass != $prev_pass){
         ...
         $message[] = '
         confirme a senha não correspondida!';
      }else{
...
<section class="form-container">
   ...
   <form action="" method="POST">
      ...
      <input type="password" name="confirm_pass" maxlength="20" placeholder="confirme sua senha" class="box" oninput="this.value = this.value.replace(/\s/g, '')">
