...
<section class="accounts">
   ...
   <h1 class="heading">conta de adm</h1>
   ...
   <div class="box" style="order: <?php if($fetch_accounts['id'] == $admin_id){ echo '-1'; } ?>;">
      ...
      <p> nome de usúario : <span><?= $fetch_accounts['name']; ?></span> </p>
      <p> total de postagens : <span><?= $total_admin_posts; ?></span> </p>
      <div class="flex-btn">
         <?php
            if($fetch_accounts['id'] == $admin_id){
         ?>
            <a href="update_profile.php" class="option-btn" style="margin-bottom: .5rem;">alterar</a>
            <form action="" method="POST">
               <input type="hidden" name="post_id" value="<?= $fetch_accounts['id']; ?>" on>
               <button type="submit" name="delete"onclick="return confirm('deletar esta conta?');" class="delete-btn" style="margin-bottom: .5rem;">deletar</button>
            </form>
         <?php
            }
         ?>
