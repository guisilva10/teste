...
if(isset($_POST['submit'])){
   ...
   if($select_admin->rowCount() > 0){
      ...
      $message[] = 'nome de usúario ou senha incorretos!!';
   }
...
<section class="form-container">
   ...
   <form action="" method="POST">
      <h3>Entrar</h3>
      <input type="text" name="name" maxlength="20" required placeholder="digite seu nome de usúario" class="box" oninput="this.value = this.value.replace(/\s/g, '')">
