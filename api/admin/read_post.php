...
<section class="read-post">
   ...
   <form method="post">
      ...
      <div class="flex-btn">
         ...
         <button type="submit" name="delete" class="inline-delete-btn" onclick="return confirm('delete this post?');">deletar</button>
   ...
   <?php
         ...
         echo '<p class="empty">nenhuma postagem foi adicionada! <a href="add_posts.php" class="btn" style="margin-top:1.5rem;">adicionar post</a></p>';
      }
   ?>
...
<section class="comments" style="padding-top: 0;">
   ...
   <p class="comment-title">Comentários da Postagem</p>
   ...
   <div class="box">
      ...
      <form action="" method="POST">
         ...
         <button type="submit" class="inline-delete-btn" name="delete_comment" onclick="return confirm('deletar este comentário?');">deletar comentário</button>
      </form>
   </div>
   <?php
         }
      }else{
         echo '<p class="empty">nenhum comentário foi feito!</p>';
      }
   ?>
   </div>
