...
if(isset($_POST['save'])){
   ...
   if(!empty($image)){
      if($image_size > 2000000){
         $message[] = 'está imagem é muito grande!!';
      }elseif($select_image->rowCount() > 0 AND $image != ''){
         $message[] = 'por favor renomeie a imagem!!';
      }else{
...
<section class="post-editor">
   ...
   <h1 class="heading">editar postagens</h1>
   ...
   <form action="" method="post" enctype="multipart/form-data">
      ...
      <select name="category" class="box" required>
         ...
         <option value="food and drinks">comidas e bebidas</option>
      ...
      <?php if($fetch_posts['image'] != ''){ ?>
         ...
         <input type="submit" value="deletar imagem" class="inline-delete-btn" name="delete_image">
      <?php } ?>
      <div class="flex-btn">
         <input type="submit" value="salvar post" name="save" class="btn">
         <a href="view_posts.php" class="option-btn">voltar</a>
         <input type="submit" value="deletar post" class="delete-btn" name="delete_post">
      </div>
   </form>
   ...
   <?php
         ...
         echo '<p class="empty">nenhum post encontrado!</p>';
   ?>
   <div class="flex-btn">
      <a href="view_posts.php" class="option-btn">Ver posts</a>
      <a href="add_posts.php" class="option-btn">Adicionar posts</a>
   </div>
   <?php
      }
   ?>
