...
if(isset($_POST['edit_comment'])){
   ...
   if($verify_comment->rowCount() > 0){
      ...
      $message[] = 'seu comentário foi editado com sucesso!';
   }
...
?>
   ...
   <form action="" method="POST">
      ...
      <textarea name="comment_edit_box" required cols="30" rows="10" placeholder="Digite seu Comentário"><?= $fetch_edit_comment['comment']; ?></textarea>
      <button type="submit" class="inline-btn" name="edit_comment">editar comentário</button>
...
<section class="comments-container">
   ...
   <p class="comment-title">seus comentários nos posts</p>
   <div class="user-comments-container">
      ...
      <div class="show-comments">
         ...
         ?>
         <div class="post-title"> Para : <span><?= $fetch_posts['title']; ?></span> <a href="view_post.php?post_id=<?= $fetch_posts['id']; ?>" >visualizar post</a></div>
         <?php
            }
         ?>
         ...
         <form action="" method="POST">
            ...
            <button type="submit" class="inline-delete-btn" name="delete_comment" onclick="return confirm('delete this comment?');">deletar comentário</button>
         </form>
      </div>
      <?php
            }
