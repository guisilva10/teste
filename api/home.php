...
<section class="home-grid">
   ...
   <div class="box-container">
      ...
      <div class="box">
         ...
         ?>
         <p> Seja Bem Vindo!! <span><?= $fetch_profile['name']; ?></span></p>
         <p>Comentários : <span><?= $total_user_comments; ?></span></p>
         ...
         <div class="flex-btn">
            ...
            <a href="user_comments.php" class="option-btn">comentários</a>
         </div>
         <?php
            }else{
         ?>
            <p class="name">login ou Registrar!</p>
            <div class="flex-btn">
      ...
      <div class="box">
         <p>categorias</p>
         <div class="flex-box">
            <a href="category.php?category=nature" class="links">natureza</a>
            <a href="category.php?category=education" class="links">educação</a>
            <a href="category.php?category=business" class="links">viagens</a>
            <a href="category.php?category=travel" class="links">negócios</a>
            <a href="category.php?category=news" class="links">novidades</a>
            <a href="category.php?category=gaming" class="links">jogos</a>
            <a href="category.php?category=sports" class="links">esportes</a>
            <a href="category.php?category=design" class="links">design</a>
            <a href="category.php?category=fashion" class="links">moda</a>
            <a href="category.php?category=persional" class="links">profissão</a>
            <a href="all_category.php" class="btn">Visualizar</a>
         </div>
      </div>
      ...
      <div class="box">
         ...
         ?>  
         <a href="authors.php" class="btn">Visualizar</a>
         </div>
      </div>
...
<section class="posts-container">
   ...
   <h1 class="heading">Posts Recentes</h1>
   ...
   <div class="box-container">
      ...
      <form class="box" method="post">
         ...
         <a href="view_post.php?post_id=<?= $post_id; ?>" class="inline-btn">ver mais</a>
      ...
      <?php
         ...
         echo '<p class="empty">nenhuma postagem adicionada!</p>';
      }
      ?>
   </div>

   <div class="more-btn" style="text-align: center; margin-top:1rem;">
      <a href="posts.php" class="inline-btn">Visualizar Tudo</a>
   </div>
